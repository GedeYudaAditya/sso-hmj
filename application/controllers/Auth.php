...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		if (!$this->ion_auth->logged_in() || !$this->ion_auth->in_group(group)) {
			...
			$this->data['user'] = $this->All_model->getTotalPengurus("2");
	...
	public function login()
	{
		if ($this->ion_auth->logged_in() && $this->ion_auth->in_group(group)) {
			...
			if ($this->form_validation->run() === TRUE) {
				...
				$judul['judul'] = 'SSO Informatics :: Login Admin';
				$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'templates/header', $judul);
				$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'login', $this->data);
				$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'templates/footer');
			}
		}
	}
	...
	public function change_password()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			// render
			$id = $_SESSION['user_id'];
			$this->data['title'] = "Users - Ubah Password";
			$this->data['active'] = "1";
			$this->data['group'] = $this->ion_auth_model->getGroup($id);
			$this->data['flip'] = "false";
			$this->load->view('admin/master/header', $this->data);
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$judul['judul'] = 'SSO Informatics :: Forgot Password';
			$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'templates/header', $judul);
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user) {
			...
			if ($this->form_validation->run() === FALSE) {
				...
				// render
				$this->data['judul'] = 'SSO Informatics :: Reset Password';
				$this->load->view('auth/templates/header', $this->data);
				$this->load->view('auth/reset_password', $this->data);
				$this->load->view('auth/templates/footer', $this->data);
			} else {
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$id = $_SESSION['user_id'];
			$this->data['title'] = "Admin - Non-Aktif User";
			$this->data['active'] = "6";
			$this->data['flip'] = "false";
			$this->data['group'] = $this->ion_auth_model->getGroup($id);
			$this->load->view('admin/master/header', $this->data);
	...
	public function create_group()
	{
		...
		$id = $_SESSION['user_id'];
		$this->data['title'] = "Admin - Tambah Level User";
		$this->data['active'] = "6";
		$this->data['flip'] = "false";
		$this->data['group'] = $this->ion_auth_model->getGroup($id);
		$this->load->view('admin/master/header', $this->data);
