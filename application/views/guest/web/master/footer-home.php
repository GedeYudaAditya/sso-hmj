            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="footer-items">
                        ...
                        <ul>
                            <li class="py-2"><a class="scroll" href="#welcome">Beranda</a></li>
                            <li class="py-2"><a class="scroll" href="#about">Tentang</a></li>
                            <li class="py-2"><a class="scroll" href="#organization">Struktur Organisasi</a></li>
                            <li class="py-2"><a class="scroll" href="#information">Pengumuman dan Berita</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="footer-items">
                        ...
                        <ul>
                            <li class="py-2" href="<?= base_url() ?>web/home">Beranda</a></li>
                            <li class="py-2"><a href="<?= base_url() ?>web/pengumuman">Pengumuman</a></li>
                            <li class="py-2"><a href="<?= base_url() ?>web/berita">Berita</a></li>
                            <li class="py-2"><a href="<?= base_url() ?>web/repositori">Repositori</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                ...
                <div class="col-12">
                    ...
                    <div
                        ...
                        <div class="copyright-right">
                            ...
                            <a href="#" class="text-primary" data-toggle="modal" data-target="#devModal">Team Dev</a>
                        </div>
                    </div>
                </div>
            </div>
