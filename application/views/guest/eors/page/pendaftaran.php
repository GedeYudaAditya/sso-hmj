                ...
                <div class="col-12 col-lg-8 mb-5">
                    ...
                    <form action="" method="POST" id="form_user" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <small id="fotoHelp" class="form-text text-muted">Gunakan foto berjas atau formal dengan
                                latar
                                belakang
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[0-9]*" minlength="11" maxlength="13" class="form-control"
                                id="wa" name="wa" aria-describedby="waHelp" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="riwayat_kesehatan" rows="4" name="riwayat_kesehatan"
                                required></textarea>
                        </div>
                        <!-- Hobi -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="2" max="4" step="0.001" class="form-control" id="ipk" name="ipk"
                                aria-describedby="ipkHelp" required>
                            <small id="ipkHelp" class="form-text text-muted">Untuk mendaftar kepanitiaan, IPK Minimal
                                2.00</small>
                        </div>
                        <!-- Data Sekolah Dasar -->
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="nama_sd" name="nama_sd"
                                        aria-describedby="nama_sd" placeholder="Masukkan Nama Sekolah Dasar" required>
                                </div>
                                <div class="col-lg-4">
                                    <input type="number" class="form-control" id="tahun_sd" placeholder="Tahun Tamat"
                                        min="2005" max="2020" name="tahun_sd" aria-describedby="tahun_sd" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="nama_smp" name="nama_smp"
                                        aria-describedby="nama_smp" placeholder="Masukkan Nama Sekolah Menengah Pertama"
                                        required>
                                </div>
                                <div class="col-lg-4">
                                    <input type="number" class="form-control" id="tahun_smp" placeholder="Tahun Tamat"
                                        min="2005" max="2020" name="tahun_smp" aria-describedby="tahun_smp" required>
                                </div>
                            </div>
                        </div>
                        <!-- Data Sekolah Dasar -->
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="nama_sma" name="nama_sma"
                                        aria-describedby="nama_sma" placeholder="Masukkan Nama Sekolah Menengah Atas"
                                        required>
                                </div>
                                <div class="col-lg-4">
                                    <input type="number" min="2005" max="2020" class="form-control" id="tahun_sma"
                                        placeholder="Tahun Tamat" name="tahun_sma" aria-describedby="tahun_sma"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="single-accordion">
                                ...
                                <div id="accordion3" class="accordion-content widget-content collapse show p-3"
                                    ...
                                    Kegiatan pendaftaran kepanitiaan <span
                                        class="text-primary"><?= $kegiatan[0]['nama_kegiatan'] ?></span> belum dapat
                                    dilakukan,
                                    silahkan baca terlebih dahulu ketentuan dan persyaratan pendaftaran agar mempermudah
                                    dalam pengisian form. Harap jangan mendaftar mendekati waktu penutupan pendaftaran,
