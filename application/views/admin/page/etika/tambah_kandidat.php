...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Data Kandidat</h1>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <input type="file" accept=".jpg, .png"
                                                    class="form-control form-control-user" name="file" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <input type="text" class="form-control form-control-user" id="ketua"
                                                    ...
                                                    name="ketua" required value="<?= set_value('ketua') ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <textarea type="text" id="visi_kandidat" rows="5" name="visi_kandidat"
                                                    required><?= set_value('visi_kandidat') ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <textarea type="text" id="misi_kandidat" rows="5" name="misi_kandidat"
                                                    required><?= set_value('misi_kandidat') ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
