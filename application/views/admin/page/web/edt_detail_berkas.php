            ...
            <div class="card-body row justify-content-center">
                <div class="col-lg-6 col-md-8">
                    <form class="user" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <select name="id_kategori_berkas" id="id_kategori_berkas"
                                                    ...
                                                    <option value="<?= $kategoriBerkas['id_kegiatan_hmj'] ?>" selected>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <input type="text" class="form-control form-control-user"
                                                    ...
                                                    value="<?= $selectedBerkas[0]['nama_repositori'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <textarea type="text" id="bidang" rows="5"
                                                    name="deskripsi_detail"><?= $selectedBerkas[0]['deskripsi_repositori'] ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <input type="hidden" class="form-control form-control-user" id="old_berkas" name="old_berkas"
                            value="<?= $selectedBerkas[0]['kode_repositori'] ?>">
